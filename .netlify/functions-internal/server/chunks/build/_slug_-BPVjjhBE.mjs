...
const virtual_nuxt__2FUsers_2Fclaudiomendonca_2FDocuments_2FGitHub_2FyoutubeSummarizerMvp_2Fnode_modules_2F_cache_2Fnuxt_2F_nuxt_2Fcontent_2Fcomponents = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  globalComponents,
  localComponents
    ...
    function resolveVueComponent(component) {
      ...
      if (typeof component === "string") {
        ...
        if (globalComponents.includes(pascalCase(component))) {
          ...
          const loader = () => {
            return Promise.resolve().then(() => virtual_nuxt__2FUsers_2Fclaudiomendonca_2FDocuments_2FGitHub_2FyoutubeSummarizerMvp_2Fnode_modules_2F_cache_2Fnuxt_2F_nuxt_2Fcontent_2Fcomponents).then((m) => {
    ...
    const { data: summary, pending, error } = useAsyncData(
      ...
      async () => {
        ...
        if (!result) {
          ...
          result = all.find((item) => item.videoId === slug) || null;
        }
        return result;
      }
    );
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_ccm_section, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (unref(pending)) {
              _push2(`<div data-v-0d47eb51${_scopeId}>Loading...</div>`);
            } else if (unref(error)) {
              _push2(`<div data-v-0d47eb51${_scopeId}>Error: ${ssrInterpolate(unref(error))}</div>`);
            } else if (!unref(summary)) {
              _push2(`<div data-v-0d47eb51${_scopeId}>Not found</div>`);
            } else {
              _push2(`<div data-v-0d47eb51${_scopeId}><div class="center" data-v-0d47eb51${_scopeId}>`);
              _push2(ssrRenderComponent(_component_nuxt_link, { to: "/" }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`Back to summaries`);
                  } else {
                    return [
                      createTextVNode("Back to summaries")
                    ];
                  }
                }),
                _: 1
              }, _parent2, _scopeId));
              _push2(`<h1 data-v-0d47eb51${_scopeId}>${ssrInterpolate(unref(summary).title)}</h1><p class="video-link" data-v-0d47eb51${_scopeId}><a${ssrRenderAttr("href", `https://www.youtube.com/watch?v=${unref(summary).videoId}`)} target="_blank" rel="noopener" data-v-0d47eb51${_scopeId}>Watch on YouTube</a></p>`);
              _push2(ssrRenderComponent(_component_ContentRenderer, {
                value: unref(summary),
                class: "prose-layout | prose"
              }, null, _parent2, _scopeId));
              _push2(`</div></div>`);
            }
          } else {
            return [
              unref(pending) ? (openBlock(), createBlock("div", { key: 0 }, "Loading...")) : unref(error) ? (openBlock(), createBlock("div", { key: 1 }, "Error: " + toDisplayString(unref(error)), 1)) : !unref(summary) ? (openBlock(), createBlock("div", { key: 2 }, "Not found")) : (openBlock(), createBlock("div", { key: 3 }, [
                createVNode("div", { class: "center" }, [
                  ...
                  createVNode("h1", null, toDisplayString(unref(summary).title), 1),
                  createVNode("p", { class: "video-link" }, [
                    createVNode("a", {
                      href: `https://www.youtube.com/watch?v=${unref(summary).videoId}`,
                      target: "_blank",
                      rel: "noopener"
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/summaries/[slug].vue");
