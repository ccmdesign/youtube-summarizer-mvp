...
const _inlineRuntimeConfig = {
  ...
  "nitro": {
    ...
    "routeRules": {
      ...
      "/__nuxt_content/summaries/sql_dump.txt": {
        "prerender": true
      },
      "/_nuxt/builds/meta/**": {
        "headers": {
  ...
  "content": {
    ...
    "localDatabase": {
      "type": "sqlite",
      "filename": "/Users/claudiomendonca/Documents/GitHub/youtube-summarizer-mvp/.data/content/contents.sqlite"
    },
    "integrityCheck": true
  }
};
...
const _PVV8Yn = eventHandler(async (event) => {
...
class RateLimiter {
  constructor(maxTokens, refillRate, refillInterval = 1e3) {
...
const _gWzNwb = eventHandler(async (event) => {
...
const handlers = [
  ...
  { route: '/__nuxt_content/:collection/sql_dump.txt', handler: _PVV8Yn, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/query', handler: _gWzNwb, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_WUxU8t, lazy: true, middleware: false, method: undefined }
];
