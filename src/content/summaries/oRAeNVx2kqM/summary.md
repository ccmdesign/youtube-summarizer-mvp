...
tldr: |
  Google's **Antigravity AI IDE** has introduced **Agent Skills**, allowing developers to package complex workflows into reusable markdown/YAML files for automated execution.
